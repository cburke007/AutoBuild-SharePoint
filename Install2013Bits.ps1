...
If (Test-Path "$env:CommonProgramFiles\Microsoft Shared\Web Server Extensions\15\BIN\stsadm.exe") #Crude way of checking if SP2013 is already installed
{
...
{
If  (Test-Path "$env:CommonProgramFiles\Microsoft Shared\Web Server Extensions\15\BIN\stsadm.exe") #Crude way of checking if SP2010 is already installed
{
